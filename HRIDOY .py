...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            HRIDOY KHAN 
\033[1;37m Facebook:            HRIDOY KHAN KH
\033[1;37m Github  :            HRIDOY KHAN 
\033[1;37m Version :            118.0
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back Hridoy Menu ")
        SSB(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back Hridoy Menu ")
    SSB(allkey)       
